...
public class Board {
    ...
    public void addRandomTile() {
        ...
        BoardSpot tile = openSpaces.get(index);
        int row = tile.getRow();
        int col = tile.getCol();
        double random = StdRandom.uniform(0,10);
    ...
    public void transpose() {
        ...
        int[][] transposedBoard = new int[m][n];
    ...
    public void flipRows() {
        ...
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < m / 2; j++) {
                ...
                gameBoard[i][j] = gameBoard[i][m - j - 1];
                gameBoard[i][m - j - 1] = temp;
            }
        }
    }
